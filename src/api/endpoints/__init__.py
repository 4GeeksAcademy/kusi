...
from api.endpoints.ingredients import ingredients_namespace
from api.endpoints.fake import fake_namespace
from api.endpoints.orders import orders_namespace
from api.endpoints.users import users_namespace
