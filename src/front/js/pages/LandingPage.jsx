...
export const LandingPage = () => {
    return(
        <div className="landing-container w-100 d-flex justify-content-between" style={{height:"100vh"}}>
            <div className="landing-img d-flex flex-column" style={{height:"100vh", width:"25%"}}>
                <img className="w-100" style={{marginTop: "auto"}} src={landingImage_1}/>
            </div>
            <div className="landing-content d-flex flex-column justify-content-center align-items-center px-5">
               <div className="landing-text text-center pb-5" >
                    <h1 style={{fontSize:"6rem"}}>Descubre los auténticos sabores del Perú en cada bocado</h1> 
                </div>
            ...
            <div className="landing-img d-flex flex-column" style={{height:"100vh", width:"25%"}}>
                <img className="w-100" src={landingImage_2}/>
            </div>
        </div>
    )
}